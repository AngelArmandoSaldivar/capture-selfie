  ...
  const getCroppedImg = (src, crop) => {
    return new Promise((resolve, reject) => {
      ...
      image.onload = () => {
        ...
        ctx.imageSmoothingQuality = 'high'; // Puedes ajustar esto a 'low', 'medium' o 'high'
        ...
        }, 'image/jpeg', 1); // Ajuste de la calidad de compresión: el valor 1 significa calidad máxima
        setShow2(!show2);
        setShow3(!show3);
      };
      image.onerror = (error) => {
